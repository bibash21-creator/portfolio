...
export default function Hero(){
  ...
  <header className={`${mono.className} text-5xl md:text-6xl lg:text-7xl text-center tracking-widest md:tracking-wide md:text-left leading-[1.3em] md:leading-[1.2em] lg:leading-[1.3em]`}>Nice to meet you! <br />
                ...
                <Link href="/contact" className={`flex gap-x-5 ${mono.className} hover:scale-150 border-b-[0.1em] border-[#7ED99E] text-xl w-[70%] md:w-[30%] lg:w-[19%]`}>Contact Me
