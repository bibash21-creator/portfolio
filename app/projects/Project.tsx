            ...
            <aside className="grid grid-rows-2 grid-cols-1 md:grid-rows-1 md:grid-cols-2 gap-x-0 md:gap-x-7">
                <div className="">
                    ...
                    <div className={`${mono.className}`}>
                       ...
                       <Link href="https://school-management-system-ten-pi.vercel.app/" className="mt-5 text-xl flex gap-x-3 bg-[#7ED99E] text-[#0D0D0D] px-5 w-[20vw] py-3 hover:scale-105 cursor-pointer border border-[#7ED99E] rounded-2xl hover:text-[#7ED99E] hover:bg-[#0D0D0D]" target="_blank">View Live Site 
                ...
                <div className="">
                    ...
                    <div className={`${mono.className}`}>
                        ...
                        <Link href="https://hospital-management-system-theta-jade.vercel.app/" className="mt-5 text-xl flex gap-x-3 bg-[#7ED99E] text-[#0D0D0D] px-5 w-[20vw] py-3 hover:scale-105 cursor-pointer border border-[#7ED99E] rounded-2xl hover:text-[#7ED99E] hover:bg-[#0D0D0D]" target="_blank">View Live Site 
                            <AiOutlineEye size={25} className="animate-pulse"/>
                        </Link>
                    </div>
                </div>
