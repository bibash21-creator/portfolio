...
const projects: Project[] = [
  {
    ...
    description: "Intuitive task management app featuring drag-and-drop functionality, priority levels, and completion analytics. Built to improve daily productivity with a focus on clean, responsive UI.",
  ...
  },
  {
    ...
    description: "Enterprise-level patient and staff management system handling appointment scheduling, patient records, and staff coordination. Designed for healthcare providers to streamline administrative workflows.",
  ...
  },
  {
    ...
    description: "Robust ticketing system for customer support teams with status tracking, priority queuing, and response time metrics. Improves support response efficiency by centralizing all customer issues.",
  ...
  },
  {
    ...
    description: "ML-powered result checking application using Streamlit. Analyzes exam performance data with pandas and implements predictive analytics for grade tracking.",
  ...
  },
  {
    ...
    description: "Sleek, responsive calculator demonstrating modular component architecture and clean code practices. Supports standard arithmetic operations with optimized performance.",
  ...
  },
  {
    ...
    description: "Recipe browsing interface with advanced filtering, search functionality, and responsive grid layout. Demonstrates UI/UX best practices for content-heavy applications.",
    tech: ["HTML5", "CSS3", "JavaScript"],
    category: "Web Design",
